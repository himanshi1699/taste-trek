...
Future<void> main() async {
  ...
  if(!kIsWeb) {
    ...
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: "AIzaSyCQSsMLTcXzb5c8s0jdDWeyVM3pvJmfOvY",
      projectId: "tastetrek-bafee",
      messagingSenderId: "741912449269741912449269",
      appId: "1:741912449269:android:b43f0367376440a0cd75bc",
    ));
